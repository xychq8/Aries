...
public class ScheduleEnums{
    public enum IdeaType implements MybatisStringTypeHandlerEnum{
        ...
        ALL_PIC_WORD("14","图文广告-图文"),
        ALL_3P("15","图文广告-三图"),
        ALL_BIG_PIC("16","图文广告-大图"),
        ALL_DOWNLOAD_PIC_WORD("17","图文广告-下载图文"),
        ALL_DOWNLOAD_BIG_PIC("18","图文广告-下载大图"),
        ALL_GIF_BIG("19","图文广告-GIF大图"),
        ALL_VIDEO("20","图文广告-视频"),
